...
let LeadsController = class LeadsController {
    ...
    findAll(skip, take, estado, usuario, search) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'usuario', required: false, type: Number }),
    ...
    __param(3, (0, common_1.Query)('usuario', new common_1.DefaultValuePipe(0), common_1.ParseIntPipe)),
