...
let UnitsController = class UnitsController {
    ...
    findAll(skip, take, desarrolloId, codigo) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'desarrolloId', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'codigo', required: false, type: String }),
    ...
    __param(2, (0, common_1.Query)('desarrolloId')),
    __param(3, (0, common_1.Query)('codigo')),
    __metadata("design:type", Function),
...
exports.UnitsController = UnitsController = __decorate([
    (0, swagger_1.ApiTags)('inventory-units'),
    (0, common_1.Controller)('inventory/units'),
